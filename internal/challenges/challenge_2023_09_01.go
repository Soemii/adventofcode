...
type Challenge20230901 struct{}

func (Challenge20230901) GetYear() int {
	return 2023
}

func (Challenge20230901) GetDay() int {
	return 9
}

func (Challenge20230901) GetChallenge() int {
	return 01
}

func (Challenge20230901) Execute(rawFile string) error {
